...
<body>
  ...
  <form name="form" action="ownersloginaccount.php" method="POST" onSubmit="return validate();">
  	              <?php
                if (isset($_SESSION["username"])) {
                    ?>
  	...
  	<input type="submit" name="submit" id="submit" value="Login"><a style="margin-left: 6%; text-decoration: none; color: turquoise; font-weight: bold; " href="login.php">Not staff</a>
