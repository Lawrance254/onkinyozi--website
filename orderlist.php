...
<div class="page-header clearfix">
 ...
 <h2 class="pull-left"><a href="dashboard.php"><img src="t17.png" width="50px" style="margin-right: 6%;"></a>Blowdry Customer List With Respect to Date Ordered</h2>
</div>

<?php
include_once 'orderlistconnect.php';
$result = mysqli_query($conn,"SELECT * FROM blow_dry");
?>
<?php
...
<td><?php echo $row["date"]; ?></td>im
 <td><a href="developers.php?id=<?php echo $username ?>" onclick="return confirm('Are you sure you want to delete this record?');">
                                <img src="t18.png" width="20px" style="margin-left: 6%;"></td>
                            </a>
</tr>
<?php
$i++;
