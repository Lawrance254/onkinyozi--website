...
<div class="page-header clearfix">
 ...
 <h2 class="pull-left"><a href="dashboard.php"><img src="t17.png" width="50px" style="margin-right: 6%;"></a>Hair Twisting Customer List With Respect to Date Ordered</h2>
</div>

<?php
include_once 'orderlistconnect.php';
$result = mysqli_query($conn,"SELECT * FROM hair_twisting");
?>
<?php
...
<td><a href="hairtwistingphp.php?username=<?php echo $username?>"><img src="t18.png" width="20px" style="margin-left: 6%;"></a></td>
</tr>
<?php
$i++;
}
